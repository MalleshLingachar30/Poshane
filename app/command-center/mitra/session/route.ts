...
function sessionInstructions() {
  ...
  return [
    ...
    "The Command Center is structured into State Overview, District Drill-Down, Land and Ownership Registry, Stakeholder and Onboarding, Species and Agro-Climatic Planning, Nursery to Species Mapping, Monitoring and Audit, and restricted Financials.",
